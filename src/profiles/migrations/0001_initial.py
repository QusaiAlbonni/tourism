    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('5000'), default_currency='USD', max_digits=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_kids', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(30), django.core.validators.MinValueValidator(0)], verbose_name='Number of Children')),
                ('avatar', app_media.models.AvatarField(max_length=1024, max_size=(256, 256), null=True, upload_to='uploads/profiles/avatars', verbose_name='Avatar')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
